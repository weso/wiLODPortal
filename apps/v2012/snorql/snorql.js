...
function Snorql() {
   // this._endpoint = document.location.href.match(/^([^?]*)snorql\//)[1] + 'sparql';
    this._endpoint = "http://http://156.35.82.103/sparql"
    ...
    var D2R_namespacePrefixes = {
	    ...
	    qb: 'http://purl.org/linked-data/cube#',
            ...
            interval: 'http://www.w3.org/2006/time#',
	    lg: 'http://linkedgeodata.org/ontology/',
	    "geo": 'http://www.w3.org/2003/01/geo/wgs84_pos#',
	    "wi-onto": 'http://data.webfoundation.org/webindex/ontology/',
	    "wi-index": 'http://data.webfoundation.org/webindex/ontology/index/',
	    "wi-component": 'http://data.webfoundation.org/webindex/ontology/component/',
	    "wi-indicator": 'http://data.webfoundation.org/webindex/indicator/',	
	    "wi-indicator-ext": 'http://data.webfoundation.org/webindex/indicator/external/',    
	    "wi-slice": 'http://data.webfoundation.org/webindex/slice/',
	    "wi-dsd": 'http://data.webfoundation.org/webindex/dsd/',
	    "wi-dataset": 'http://data.webfoundation.org/webindex/dataset/',
	    "wi-observation": 'http://data.webfoundation.org/webindex/observation/',
	    "wi-area": 'http://data.webfoundation.org/webindex/area/area/',
	    "wi-region": 'http://data.webfoundation.org/webindex/area/region/',
	    "wi-country": 'http://data.webfoundation.org/webindex/area/country/',
